...
public class Demo {
    ...
    private ToutiaoSDK sdk = new ToutiaoSDK("http://localhost:10041");
    private ToutiaoSDK2 sdk2 = new ToutiaoSDK2("http://localhost:10041");
    ...
    public String code2Session2(
            @RequestParam String anonymous_code)  {
        try {
